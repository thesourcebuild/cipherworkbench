 ...
 */
export interface ToolExportFile {
  /** Relative filename within the export folder (e.g. "ca.crt", "server.key", "client.p12") */
  name: string;
  /** File contents as UTF-8 string or raw binary Uint8Array */
  content: string | Uint8Array;
  /** Optional MIME type for direct browser download */
  mimeType?: string;
}
...
export interface ToolResult {
  ...
  error?: string;
  /**
   * Optional named individual files generated by the computation (e.g. certificates, keys, configs)
