...
export const MAC_TOOLS: readonly MacToolMeta[] = [
  ...
  },
  {
    id: "gmac",
    label: "GMAC",
    category: "Galois / Universal",
    outputLen: 16,
    security: "modern",
    tags: ["gmac", "nist", "sp800-38d", "gcm", "ghash", "aes", "authentication"],
    summary: "NIST SP 800-38D standalone Galois Message Authentication Code over GF(2^128).",
    streaming: false,
  },
  {
    id: "umac",
    ...
    outputLen: 8,
    security: "modern",
    tags: ["umac", "rfc4418", "nh", "universal", "mac", "high-speed"],
    summary: "RFC 4418 Universal Message Authentication Code using NH vector hashing.",
    streaming: false,
  },
  {
    id: "cbc-mac",
    ...
    outputLen: 8,
    security: "legacy",
    tags: ["cbc-mac", "daa", "ansi x9.9", "fips113", "des", "aes", "banking"],
    summary: "ANSI X9.9 / FIPS PUB 113 Data Authentication Algorithm in CBC mode.",
    streaming: false,
  },
  {
    id: "lightmac",
    ...
    outputLen: 16,
    security: "modern",
    tags: ["lightmac", "iso29192", "lightweight", "iot", "counter", "aes"],
    summary: "ISO/IEC 29192-6 lightweight variable-input-length message authentication code.",
    streaming: false,
  },
];
