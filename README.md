...
Cipher Workbench ships **476 tools** organized across 12 families:

| Family | Tools | Algorithms & Capabilities |
|---|---|---|
| **Hashes** | 164 | MD2, MD4, MD5, SHA-1, SHA-2 (224/256/384/512, 512/224, 512/256), SHA-3 (224/256/384/512), Keccak, SHAKE128/256, cSHAKE, TupleHash, ParallelHash, TurboSHAKE, KangarooTwelve, RIPEMD (128/160/256/320), BLAKE, BLAKE2b/2s, BLAKE3, SM3, Streebog-256/512, Tiger/Tiger2, Skein (256/512/1024), Ascon-Hash/XOF, HAVAL (15 variants), Snefru-256, GOST R 34.11-94, Whirlpool, MD5-SHA1, FNV-1/1a (32/64/128/256/512-bit), Jenkins, MurmurHash3, XXH32/64/3/128, Groestl, JH, CubeHash, Luffa, Fugue, SHAvite-3, Shabal, BelT-Hash, Rapidhash, HighwayHash, SpookyHash, CityHash, FarmHash, t1ha, wyhash, Poseidon, Poseidon2, MiMC, Tip5, Rescue-Prime, Monolith, Neptune, Reinforced Concrete, Anemoi, Griffin, Haraka-256/512, MeowHash, KomiHash, N-Hash, FSB, HAS-160, Kupyna, LSH |
| **Ciphers** | 120 | AES (128/192/256) in GCM / GCM-SIV / CCM / OCB / XTS / CTR / CBC / OFB / CFB / SIV / Key Wrap (RFC 3394 & 5649) / ECB; ChaCha20-Poly1305, XChaCha20-Poly1305, raw ChaCha20/12/8; XSalsa20-Poly1305, Salsa20; Ascon-AEAD128, AEGIS-128L/256; Camellia, ARIA, SM4 (GCM/CCM/CBC/CFB/OFB/CTR/ECB); Magma and Kuznyechik (GOST R 34.12-2015); Twofish, Serpent, Blowfish, CAST5/6, SEED, IDEA, SAFER+, RC2/4/5/6, 3DES, DES; SHACAL-1/2, QARMA-64, MANTIS-7, CRAFT, Midori-64, Kalyna, KASUMI, Khazad, MISTY1, HIGHT, CLEFIA, RoadRunneR; Fernet; LWC block & stream ciphers (PRESENT, LED, PRIDE, PRINCE, SKINNY, RECTANGLE, SPARX, SIMON, SPECK, Piccolo, CHAM, TEA/XTEA/XXTEA, LS-Design, GIFT-COFB, Romulus, ISAP, Photon-Beetle, Sparkle, Elephant, NORX, MORUS, ACORN, Ketje Jr, Deoxys-II, GSM A5/1 & A5/2, RC4-drop, SNOW 3G, SNOW-V, Sosemanuk, Grain, ZUC, BelT, ISAAC, PCG64, Xoshiro256++, Spritz, Crypto1, DECT-DSC, GEA, Adiantum, HCTR2, SIMECK, LILLIPUT, SATURNIN). All bidirectional |
...
| **Classical** | 32 | Caesar, ROT13, Vigenère, Beaufort, Autokey, Playfair, Hill, Polybius, Bifid, Trifid, Four-Square, Two-Square, Affine, Atbash, Rail Fence, Columnar Transposition, Enigma (I, M3, M4), Typex, SIGABA, Bazeries M-94 Cylinder, Hagelin M-209, Lorenz SZ40/SZ42, Solitaire/Pontifex, ADFGX/ADFGVX, Nihilist, Straddling Checkerboard, Bacon's Cipher, Chaocipher, VIC Cipher, Alberti Cipher Disk, Porta, Gronsfeld, Jefferson Disk, Fractionated Morse, Scytale |
| **Encodings** | 25 | Hex (Base16), Base32 (RFC 4648, base32hex, Crockford), Base58 (Bitcoin, Ripple, Flickr), Base58Check, Base62, Base36, Bech32 & Bech32m (BIP-173 / BIP-350), Base64 (standard and URL-safe), Base85 (Ascii85, Z85, RFC 1924), basE91, Base45, Proquints, Punycode, Quoted-Printable (MIME), UUEncode, Morse Code, Bencode, CBOR (RFC 8949), Bubble Babble, Baudot ITA2, PGP Word List, Reflected Binary Gray Code, BinHex 4.0, GSM 03.38, OpenPGP ASCII Armor — all bidirectional |
| **Key derivation** | 27 | PBKDF2, HKDF, HKDF-Expand-Label (TLS 1.3 RFC 8446), SP 800-108 (NIST Counter Mode), BIP-39 (Mnemonic & Seed), BIP-32/BIP-44 (HD Key Derivation), scrypt, Argon2 (i/d/id with pepper & AAD), bcrypt / bcrypt-pbkdf — with Verify mode — EvpKDF (OpenSSL `EVP_BytesToKey`), Balloon Hashing, Catena, Yescrypt, ANSI X9.63, OpenPGP S2K, SSHv2 KDF, TLS 1.2 PRF, HPKE KDF, WPA-PSK (PBKDF2-HMAC-SHA1), One-Step KDF (SP 800-56A/C), crypt(3), descrypt, BSD-crypt |
| **MACs** | 23 | HMAC over 55 hashes (PHP `hash_hmac_algos` set + SM3, BLAKE1/2, Skein, Streebog), KMAC128/256 with customization, Skein-MAC, Ascon-MAC, Ascon-PRF/PRFShort, Poly1305, Poly1305-AES, AES-CMAC, Pelican MAC, SipHash-2-4, SipHash-1-3, SipHash-4-8, HalfSipHash-2-4, HighwayHash, Chaskey, PMAC-AES, VMAC (RFC 6605), GMAC (NIST SP 800-38D), UMAC (RFC 4418), CBC-MAC / DAA (ANSI X9.9 / FIPS 113), LightMAC (ISO/IEC 29192-6), Retail MAC (ANSI X9.19 / ISO 9797-1) |
| **Public key & Post-quantum** | 17 | RSA (keygen, PSS & PKCS#1 v1.5 signatures across 15 hashes, OAEP encryption), ECDSA over P-256/384/521 and secp256k1, Ed25519, ECDH over X25519 & P-curves, Post-Quantum ML-KEM (FIPS 203), ML-DSA (FIPS 204), SLH-DSA (FIPS 205), Falcon, Classic McEliece, HQC, NTRUEncrypt (HRSS), SQISign, Stateful Hash Signatures (LMS/HSS & XMSS), Shamir's Secret Sharing, SLIP-0039, Pedersen Commitments, Paillier Homomorphic Encryption |
| **Certificates & PKI** | 12 | Certificate Creator (self-signed and CA-signed X.509 v3 TLS/SSL), CSR Creator (PKCS#10), CSR Signer (in-browser Micro-CA), X.509 Certificate Inspector, CSR Inspector, CRL Revocation List (RFC 5280 v2), Certificate Converter (PEM/DER/SPKI), Chain Verifier (path validation & trust), Cert & Key Matcher, Certificate Diff (side-by-side audit), OCSP Inspector & Builder (RFC 6960), ACME Challenge Calculator (RFC 8555 HTTP-01 / DNS-01) |
...
| **Checksums** | 17 | Sum check (8/16/32-bit over bytes or words), one’s complement sum (Internet checksum RFC 1071), two’s complement checksum, XOR checksum, LRC, BCC, Fletcher-16, Fletcher-32, Adler-32; Check digits and financial identifiers: Verhoeff, Damm, Luhn, ISBN-10/13, IBAN, ABA Routing Number, CUSIP/ISIN, SEDOL |
| **Parity & ECC** | 7 | UART/Serial character parity (Even, Odd, Mark, Space), Hamming code ECC (7,4 / 15,11 / 31,26 / 63,57), BCH codes (QR format & version), Reed-Solomon ECC, Longitudinal parity, Golay code ECC (23,12 / 24,12), Hadamard / Walsh code ECC |
...
packages/
  ...
  tools/
    asymmetric/ certificates/ checksum/ cipher/ classical/ crc/
    encoding/ format/ hash/ kdf/ mac/ parity/
...
tests/              4600+ tests across 125 test suites, driven by published vectors and OpenSSL parity
```
